...
Before installing the VirusTotal OpenDXL JavaScript service, change to the
...
[npm package registry](https://www.npmjs.com/package/@opendxl/dxl-vtapi-service), run:

```sh
npm install @opendxl/dxl-vtapi-service --save
```
